...
// ShippingAddress Img
import DelivaryImgUrl1 from '../../public/images/landing-9/delivary1.png';
import DelivaryImgUrl2 from '../../public/images/landing-9/delivary2.png';
import DelivaryImgUrl3 from '../../public/images/landing-9/delivary3.png';
import DelivaryImgUrl4 from '../../public/images/landing-9/delivary4.png';
              ...
              <Row>
                ...
                <Col sm={12} md={4}>
                  ...
                  <div className='FooterUlBox'>
                    ...
                    <ul>
                      <li> <BiPhoneCall/> <Link href="">+8801894844452</Link></li>
                      <li> <BsEnvelope/> <Link href="">support@funnelliner.com</Link></li>
                    </ul>
                ...
                <Col sm={12} md={4}>
                  ...
                  <div className='FooterUlBox'>
                    ...
                    <ul>
                      ...
                      <li> <img src="/images/landing-9/check.svg" alt="alt" />  <Link href=""> Refund Policy </Link></li>
                      <li> <img src="/images/landing-9/check.svg" alt="alt" />  <Link href="">Privacy Policy</Link></li>
                      <li> <img src="/images/landing-9/check.svg" alt="alt" />  <Link href="">Terms and Conditions</Link></li>
