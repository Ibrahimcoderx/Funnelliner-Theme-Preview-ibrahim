                                ...
                                <div className="Landing__19__Banner__TextContent">
                                    ...
                                    <div className="Landing__19__Banner__Price d_flex">
                                        ...
                                        <Link href="#placeAnOrder" >
                                                ...
                                                <button className="button type1">অর্ডার করুন</button>
                        ...
                        <Row>
                            ...
                            <Col lg={6}>
                                ...
                                <div className="Landing__19__TinyFooter__Logo">
                                    <img src="/images/landing-19/white-logo.png" alt="" />

                                    <ul>
                                        <li><Link href=''> <FiChevronRight/> Privacy Policy </Link></li>
                                        <li><Link href=''> <FiChevronRight/> Terms and Conditions </Link></li>
                                        <li><Link href=''> <FiChevronRight/> Refund Policy  </Link></li>
                                    </ul>
                            ...
                            <Col lg={6}>
                                ...
                                <div className="Landing__19__TinyFooter__Contact">
                                    ...
                                    <ul>
                                        <li><Link href=''> <FiPhoneCall/> 01894844452</Link></li>
                                        <li><Link href=''> <BsEnvelopeAt/> support@funnelliner.com</Link></li>
                                    </ul>
